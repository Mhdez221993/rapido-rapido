const modalCommentNewLayout = `<section id="modal-comments-new" class="l-modal">
        ...
        <textarea id="comment-text" placeholder=" Input your text here ..." minlength="5" required>     
        </textarea>    
        <input id="comment-name" class="comment-new-name" type="text" placeholder="Input your name here" minlength="3" required/>    
